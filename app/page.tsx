...
export default function MathFractionApp() {
  ...
  const [currentView, setCurrentView] = useState<'home' | 'material' | 'quiz' | 'result'>('home');
      ...
      <main className="flex-1 max-w-6xl w-full mx-auto p-4 sm:p-6 flex flex-col">
        ...
        {currentView === 'home' && (
          <div className="space-y-8 animate-in fade-in duration-300">
            ...
            <div className="p-5 rounded-3xl bg-slate-100/90 border border-slate-200/90 flex flex-col sm:flex-row items-center justify-between gap-4">
              <div className="flex items-center gap-4 text-center sm:text-left">
                ...
                >
                  <img
                    ...
                    alt="Pas-Foto"
                    className="w-12 h-16 rounded-xl object-cover object-top border-2 border-white shadow-xs"
                  />
                </a>
                <div>
                  <div className="text-[11px] font-bold text-blue-600 uppercase tracking-wide">
                    Pengembang & Guru Kelas:
                  </div>
                  <div className="font-extrabold text-slate-900 text-sm">
                    Robiyanto, S.Pd. (NIP. 19930720 201902 1 005)
                  </div>
                  <div className="text-xs text-slate-500">
                    SD Negeri 2 Kebondalem, Banjarnegara • robiyantospd07@guru.sd.belajar.id
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="px-4 py-2 rounded-xl bg-white hover:bg-slate-200 text-slate-800 text-xs font-bold border border-slate-200 transition-colors shadow-2xs"
                >
                  Lihat Profil
                </button>
                <button
                  onClick={() => downloadStandaloneHtml()}
                  className="px-4 py-2 rounded-xl bg-blue-600 hover:bg-blue-700 text-white text-xs font-bold transition-colors shadow-2xs flex items-center gap-1.5"
                >
