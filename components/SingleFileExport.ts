...
<head>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Plus Jakarta Sans', -apple-system, sans-serif; }
    ...
    .dev-box { display: flex; align-items: center; gap: 16px; padding: 16px; background: #F8FAFC; border-radius: 18px; border: 1px solid #E2E8F0; }
    .dev-img { width: 70px; height: 90px; border-radius: 12px; object-fit: cover; border: 2px solid white; box-shadow: 0 4px 6px rgba(0,0,0,0.1); }
  ...
  <main class="container" style="flex: 1; padding-top: 30px;">
    ...
    <div id="screenHome" class="card">
      <div style="text-align: center; max-width: 650px; margin: 0 auto; padding: 10px 0;">
        ...
        <div class="dev-box" style="text-align: left;">
          <a href="https://ibb.co.com/RkLn8FYH" target="_blank">
            <img src="https://i.ibb.co.com/YFv9gCPj/Pas-Foto.jpg" alt="Pas-Foto" class="dev-img" />
          </a>
          <div>
            <div style="font-size: 11px; font-weight: 700; color: #2563EB;">PENGEMBANG MEDIA:</div>
            <div style="font-size: 15px; font-weight: 800; color: #0F172A;">Robiyanto, S.Pd.</div>
            <div style="font-size: 12px; color: #475569;">NIP: 19930720 201902 1 005 • SD Negeri 2 Kebondalem, Banjarnegara</div>
            <div style="font-size: 11px; color: #2563EB; margin-top: 2px;">robiyantospd07@guru.sd.belajar.id</div>
          </div>
        </div>
      </div>
    </div>
